...
def configure_runtime(args):
    ...
    prompt_candidates.extend(
        [
            ...
            os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "prompts", "detailed_score_system.txt"),
        ]
    )
...
def build_judge_messages(input_text, input_images, output_text_list, output_images, include_input_images=True, include_output_images=True, note_text=None):
...
def main_evaluate_output_directory(output_dir, resume=True, limit=None, retry_invalid_scores=False, workers=DEFAULT_WORKERS, save_every=DEFAULT_SAVE_EVERY):
    """
    ...
    save_judge_results(judge_results)
    print(f"GPT scoring finished. saved_results={len(judge_results)}, failed_tasks={failed_count}, output_file={OUTPUT_FILE}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--opening_root', type=str, default=os.getcwd(),
                       help='Root directory of the OpenING workspace')
    parser.add_argument('--benchmark_dir', type=str, default=None,
                       help='Optional explicit path to OpenING-benchmark directory')
    parser.add_argument('--pk_file', type=str, default=None,
                       help='Optional explicit path to pairwise PK JSON file')
    parser.add_argument('--prompt_file', type=str, default=None,
                       help='Optional explicit path to detailed_score_system.txt')
    ...
    parser.add_argument('--output_file', type=str, default=None,
                       help='Path to save GPT score results JSON')
    ...
    parser.add_argument('--no_resume', action='store_true',
                       help='Do not skip samples already present in --output_file')
    parser.add_argument('--retry_invalid_scores', action='store_true',
                       help='Retry existing results whose score metrics are missing, null, or non-numeric')
    parser.add_argument('--limit', type=int, default=None,
                       help='Only score the first N pending tasks, useful for smoke tests')
