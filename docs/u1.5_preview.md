...
- `[2026.08.04]` Community contributor [smthem on Hugging Face](https://huggingface.co/smthem) (GitHub [@smthemex](https://github.com/smthemex)) released [`SenseNova-U1.5-8B-MoT-Preview-Q8.gguf`](https://huggingface.co/smthem/SenseNova-U1-8B-MoT-Merger-gguf/blob/main/SenseNova-U1.5-8B-MoT-Preview-Q8.gguf) (19.9 GB). Thank you to the author for creating and maintaining quantized SenseNova-U1 weights for the community.
...
- `[2026.05.08]` Added **GGUF quantized-weight support** and a **layered-loading VRAM mode** for inference on a single GPU with limited memory. See the [low-VRAM inference guide](https://github.com/OpenSenseNova/SenseNova-U1/blob/main/README.md#-memory-efficient-inference-gguf--vram-modes). GGUF weights for `SenseNova-U1-8B-MoT-Merger` are available from [smthem on Hugging Face](https://huggingface.co/smthem/SenseNova-U1-8B-MoT-Merger-gguf); thanks to GitHub [@smthemex](https://github.com/smthemex) for contributing them to the community.
