...
For tasks with a clear subject and few constraints, start with a direct natural-language prompt. The workflows below are most useful when a short brief needs a complete visual plan, a mature reference design should be reinterpreted, or an edit contains several preservation constraints.
...
The checked-in examples below illustrate how the optional planning workflows affect a request. They are workflow comparisons, not benchmark results.
