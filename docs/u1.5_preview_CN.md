...
<details>
<summary>Image PE Skill：代码与使用示例（待发布）</summary>

<!-- TODO(pe-release):
1. 添加 Skill 仓库与版本链接；
2. 添加 Codex/CLI 安装命令；
3. 添加 brief -> enhanced prompt 示例；
4. 添加 enhanced prompt -> U1.5 推理命令；
5. 添加相同输入下 raw prompt 与 PE 的可复现对比。 -->

正式发布时将在这里补充安装、调用与完整示例。
  ...
  <tbody>
    <tr>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/origin.png"><img width="150" height="150" alt="Caption-to-Prompt 原始参考图" src="../src/sensenova_u1_5/caption/img/origin.png"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k.webp"><img width="150" height="150" alt="Caption-to-Prompt 反向还原结果" src="../src/sensenova_u1_5/caption/img/baby_4k.webp"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k_BNB.webp"><img width="150" height="150" alt="Caption-to-Prompt V0 修改结果" src="../src/sensenova_u1_5/caption/img/baby_4k_BNB.webp"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k_LMA.webp"><img width="150" height="150" alt="Caption-to-Prompt V1 修改结果" src="../src/sensenova_u1_5/caption/img/baby_4k_LMA.webp"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k_enjoy.webp"><img width="150" height="150" alt="Caption-to-Prompt V2 修改结果" src="../src/sensenova_u1_5/caption/img/baby_4k_enjoy.webp"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k_high_five.webp"><img width="150" height="150" alt="Caption-to-Prompt V3 修改结果" src="../src/sensenova_u1_5/caption/img/baby_4k_high_five.webp"></a>
      </td>
      <td align="center" valign="top">
        <a href="../src/sensenova_u1_5/caption/img/baby_4k_wine.webp"><img width="150" height="150" alt="Caption-to-Prompt V4 修改结果" src="../src/sensenova_u1_5/caption/img/baby_4k_wine.webp"></a>
      </td>
    </tr>
  </tbody>
</table>
...
Editing PE 默认开启，并且需要配置 `TOKENHUB_API_KEY`。使用
